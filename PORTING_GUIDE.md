...
- Axis now no longer has `"layer"` property. Instead, there is now a `"zindex"` property (default `0`). By default, axes should be drawn behind all chart elements. To put them in front, use `"zindex": 1`.
